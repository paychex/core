...
import { collection } from '../models/index.mjs';
import {
    withOrdering,
    withFiltering,
    withSelection,
    ...
    describe('utils', () => {
        ...
        describe('withGrouping', () => {
            ...
            it('respects filter', () => {
                ...
                const d = { key: 'b', num: 5 };
                const e = { key: 'a', num: 4 };
                list = withGrouping(withFiltering(collection(), isOdd), 'key');
                list.add(a, b, c, d, e);
            ...
            it('respects ordering', () => {
                ...
                const d = { key: 'b', num: 5 };
                const e = { key: 'a', num: 3 };
                list = withGrouping(withOrdering(collection(), ['num']), 'key');
                list.add(a, b, c, d, e);
                expect(list.groups()).toMatchObject({
                    a: [c, e, a],
                    b: [b, d]
        ...
        describe('withActive', () => {
            ...
            it('initializes active from factory items', () => {
                list = withActive(collection(1, 2, 3));
            ...
            it('ignores filtered', () => {
                const isOdd = num => num % 2;
                list = withActive(withFiltering(collection(), isOdd));
                list.add(1, 2, 3, 4, 5);
            ...
            it('works with ordered grouping', () => {
                ...
                list = withOrdering(collection(), ['key']);
                list = withGrouping(list, 'key');
            ...
            it('updates active when filtered out', () => {
                list = withActive(withFiltering(collection()));
                list.add(1, 2, 3, 4, 5);
        ...
        describe('withSelection', () => {
            ...
            it('ignores filtered', () => {
                const isOdd = num => num % 2;
                list = withSelection(withFiltering(collection(), isOdd));
                list.add(1, 2, 3, 4, 5);
                expect(list.items()).toEqual([1, 3, 5]);
            ...
            it('updates selection when filter changes', () => {
                const isOdd = num => num % 2;
                list = withSelection(withFiltering(collection()));
                list.add(1, 2, 3, 4, 5);
        ...
        describe('withPaging', () => {
            ...
            it('correctly initializes', () => {
                list = withPaging(collection(1, 2, 3, 4, 5), 2);
                expect(list.pageIndex()).toBe(0);
                expect(list.items()).toEqual([1, 2]);
            });
            ...
            it('sets page within bounds on filter-change', () => {
                const isOdd = num => num % 2;
                list = withPaging(withFiltering(collection(1, 2, 3, 4, 5)), 2);
                expect(list.nextPage()).toBe(1);
                expect(list.nextPage()).toBe(2);
                list.filterBy(isOdd);
        ...
        describe('withUnique', () => {
            ...
            it('accepts factory selector', () => {
                ...
                const b = { key: 'b' };
                const c = { key: 'a' };
                list = withUnique(collection(), 'key');
                list.add(a, b, c);
            ...
            it('works with previous list items', () => {
                ...
                const b = { key: 'b' };
                const c = { key: 'a' };
                list = withUnique(collection(a, b, c), 'key');
                expect(list.items()).toEqual([a, b]);
            });
