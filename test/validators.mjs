...
describe('validators', () => {
    ...
    describe('object', () => {
        ...
        it('throws if message not provided', () => {
            expect(() => object({})).toThrow('An error message must be provided.');
        });
        ...
        it('throws if schema value is not a function', () => {
            expect(() => object({ key: 'value' }, 'message')).toThrow(
                'Schema must be an object whose values are Validator functions.');
        });
    ...
    describe('array', () => {
        ...
        it('throws if message not provided', () => {
            expect(() => array({})).toThrow('An error message must be provided.');
        });
    ...
    describe('string', () => {
        ...
        it('throws if message not provided', () => {
            expect(() => string({})).toThrow('An error message must be provided.');
        });
    ...
    describe('number', () => {
        ...
        it('throws if message not provided', () => {
            expect(() => number({})).toThrow('An error message must be provided.');
        });
    ...
    describe('date', () => {
        ...
        it('throws if message not provided', () => {
            expect(() => date({})).toThrow('An error message must be provided.');
        });
    ...
    describe('empty', () => {
        ...
        it('throws if message not provided', () => {
            expect(() => empty({})).toThrow('An error message must be provided.');
        });
    ...
    describe('oneOf', () => {
        ...
        it('throws if message not provided', () => {
            expect(() => oneOf()).toThrow('An error message must be provided.');
        });
    ...
    describe('not', () => {
        ...
        it('throws if message not provided', () => {
            expect(() => not(spy())).toThrow('An error message must be provided.');
        });
        ...
        it('returns validator', () => {
            expect(not(spy(), 'message')).toBeInstanceOf(Function);
        });
    ...
    describe('range', () => {
        ...
        it('throws if message not provided', () => {
            expect(() => range(0, 0)).toThrow('An error message must be provided.');
        });
    ...
    describe('matches', () => {
        ...
        it('throws if message not provided', () => {
            expect(() => matches(/rx/)).toThrow('An error message must be provided.');
        });
    ...
    describe('some', () => {
        ...
        it('throws if message not provided', () => {
            expect(() => some(spy())).toThrow('An error message must be provided.');
        });

        it('throws if non-function validator provided', () => {
            expect(() => some([null], 'invalid')).toThrow('A non-validator was provided.');
        });
    ...
    describe('every', () => {
        ...
        it('throws if message not provided', () => {
            expect(() => every(spy())).toThrow('An error message must be provided.');
        });
        ...
        it('returns validator', () => {
            expect(every(spy(), 'message')).toBeInstanceOf(Function);
        });
    ...
    describe('instanceOf', () => {
        ...
        it('throws if message not provided', () => {
            expect(() => instanceOf(RegExp)).toThrow('An error message must be provided.');
        });
