...
import { create, utils } from '../formatters/index';
import { Formats, Formatter } from '../formatters';
...
describe('formatters', () => {
    ...
    it('uses defaults', () => {
        ...
        expect(create.bind(null, {})).not.toThrow();
    });
    ...
    describe('utils', () => {
        ...
        describe('tokens', () => {
            ...
            it('throws if non-array provided', () => {
                expect(() => utils.tokens.call(null)).toThrow();
                expect(() => utils.tokens.call(null, '')).toThrow();
            });

            it('throws if array of non-array provided', () => {
                expect(() => utils.tokens([])).toThrow();
                expect(() => utils.tokens.call(null, [123])).toThrow();
                expect(() => utils.tokens.call(null, ['abc'])).toThrow();
            });
        ...
        describe('withReplacement', () => {
            ...
            ].forEach(([name, pattern, replacer]: [string, string|RegExp, string|(()=>string)]) => {
    ...
    describe('toNumber', () => {
        ...
        ].forEach(([name, input, output]: [string, number, string]) => {
    ...
    describe('toRelativeDateTime', () => {
        ...
        it('works with extra long time frames', () => {
            ...
            const stop = Date.parse(String(start)) + 4000 * ONE_YEAR;
